  ...
  async initialize() {
    ...
    try {
      ...
      this.client.on("qr", (qr) => {
        console.log(
          "[WhatsApp] QR Code received. Scan once to connect permanently.",
        );
        this.qrCode = qr;
      });
      ...
      this.client.on("authenticated", () => {
        console.log(
          "[WhatsApp] Authenticated! Session saved — future restarts will reconnect automatically.",
        );
        this.qrCode = null;
      });
      ...
      this.client.on("auth_failure", async (msg) => {
        ...
        this._wipeSession();
        console.log(
          "[WhatsApp] Session wiped. Re-initializing to show fresh QR...",
        );
      ...
      this.client.on("disconnected", async (reason) => {
        ...
        if (this.reconnectAttempts < this.maxReconnectAttempts) {
          ...
          console.log(
            `[WhatsApp] Reconnect attempt ${this.reconnectAttempts} in ${delay / 1000}s...`,
          );
