...
export default function AnalyticsPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: overview?.recentCompletions ?? 0,
      tag: "This month",
      color: "#7F77DD",
    },
    {
    ...
    {
      label: "Milestones",
      value: overview?.milestoneReached ?? 0,
      tag: "Achieved",
      color: "#E8883A",
    },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Total completions per habit category
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Streak, completion rate, and consistency
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {radarData.length === 0 ? (
                ...
                <div className="space-y-4">
                  {habits.length === 0 ? (
                    ...
                    [...habits]
                      .sort(
                        (a, b) =>
                          (b.stats?.currentStreak || 0) -
                          (a.stats?.currentStreak || 0),
                      )
                      .map((h: any, i: number) => {
                        const maxStreak = Math.max(
                          ...habits.map(
                            (x: any) => x.stats?.currentStreak || 0,
                          ),
                          1,
                        );
                        const pct = Math.round(
                          ((h.stats?.currentStreak || 0) / maxStreak) * 100,
                        );
                        const medal =
                          i === 0
                            ? "🥇"
          ...
          <TabsContent value="daily" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Last 30 days of habit completions
                </CardDescription>
              </CardHeader>
              <CardContent>
                {dailyData.length === 0 ? (
          ...
          <TabsContent value="heatmap" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your habit completion activity for the year
                </CardDescription>
              </CardHeader>
              <CardContent>
    ...
    <div className="overflow-x-auto">
      <div className="inline-block p-4">
        <div
          ...
          style={{
            gridTemplateColumns: `repeat(${Math.ceil(days.length / 7)}, 13px)`,
          }}
        >
          {days.map((date) => (
            <div
